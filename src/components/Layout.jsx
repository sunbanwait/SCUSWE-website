...
function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-primary-white font-sans text-text-eggplant font-bold antialiased overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="bg-bg-lavender py-12 rounded-none md:rounded-t-[3rem] shadow-[0_-10px_30px_-15px_rgba(140,122,190,0.3)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            <span className="font-bold text-text-eggplant text-lg text-center md:text-left">Santa Clara University SWE</span>
          </div>

          <div className="text-sm text-text-eggplant font-bold text-center w-full md:w-auto">
            &copy; {new Date().getFullYear()}{' '}
            <span className="md:hidden">SCU SWE</span>
            <span className="hidden md:inline">Santa Clara University Society of Women Engineers.</span>
          </div>
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 justify-center bg-primary-white px-6 py-3 rounded-full shadow-md shadow-purple-100/50">
            ...
            <a href="https://www.linkedin.com/company/swe-society-of-women-engineers-santa-clara-university-chapter" target="_blank" rel="noopener noreferrer" className="flex items-center text-text-eggplant font-bold hover:text-text-eggplant hover:-translate-y-1 transition-all" aria-label="LinkedIn">
